...
- (void)awakeFromNib
{
    ...
    //[self.contentView setRightBarButtonItem:[JSQMessagesToolbarButtonFactory defaultSendButtonItem] andSecondButton:[JSQMessagesToolbarButtonFactory defaultSendButtonItem]];
