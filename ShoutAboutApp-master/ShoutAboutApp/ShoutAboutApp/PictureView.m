...
- (id)initWith:(NSString *)objectId :(NSArray *)messages
{
    ...
    {
        JSQPhotoMediaItem* photoMedia  = (JSQPhotoMediaItem*) message.media;
        if (photoMedia.image != nil)
        {
            NSString *title = message.senderId;
            //-------------------------------------------------------------------------------------------------------------------------------------
            ...
            //-------------------------------------------------------------------------------------------------------------------------------------
            NYTPhotoItem *photoItem = [[NYTPhotoItem alloc] init];
            photoItem.image = photoMedia.image;
            ...
            photoItem.objectId = message.messageID;
            //-------------------------------------------------------------------------------------------------------------------------------------
            if ([message.messageID isEqualToString:objectId]) initialPhoto = photoItem;
